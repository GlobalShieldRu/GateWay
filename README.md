...
```bash
git clone https://github.com/GlobalShieldRu/GateWay.git /root/GSG && bash /root/GSG/install.sh
```
...
Зайдите по SSH на GSG и запустите установочный скрипт заново — он подтянет обновления из GitHub и перезапустит сервисы:
